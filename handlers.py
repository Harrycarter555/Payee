...
def shorten_url(long_url: str) -> str:
    api_token = os.getenv('URL_SHORTENER_API_KEY')
...
def handle_file(update: Update, context: CallbackContext):
    try:
        ...
        update.message.reply_text(f'An error occurred while processing your file: {e}. Please try again later.')
        return ConversationHandler.END
...
def ask_file_name(update: Update, context: CallbackContext):
    ...
    file_opener_url = f'https://t.me/{os.getenv("FILE_OPENER_BOT_USERNAME")}?start={encoded_url}&&{file_name}'
